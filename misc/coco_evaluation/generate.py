...
if __name__ == '__main__':
    ...
    if "v2-1_512-ema-pruned" in arg.ckpt:
        opt.config = "/share/project/yfl/codebase/git/AltTools/Altdiffusion/src/configs/v2-inference.yaml"
    else:
