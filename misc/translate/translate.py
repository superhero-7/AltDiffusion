...
def translation(df,lg):
    ...
    tokenizer = MBart50TokenizerFast.from_pretrained("/share/project/yfl/database/hub/v/snapshots/0ece2bb75a89350002537169ecadeb2b3d043b6b")
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(tqdm(test_dataloader)):
            ...
            output_tokens = model.generate(**batch,max_length=75,num_beams=5, forced_bos_token_id=tokenizer.lang_code_to_id[lg])
