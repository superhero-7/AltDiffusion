...
def inception_score(imgs, device="cuda:0", batch_size=32, resize=False, splits=1):
...
if __name__ == '__main__':
    ...
    cifar = dset.CIFAR10(root='/home/xingzhaohu/sharefs/datasets/cifar10', download=False,
