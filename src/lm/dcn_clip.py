...
from lm.models.modeling_altclip import AltCLIPModel
...
class DCNCLIP30M1024(AbstractEncoder):
    ...
    def __init__(self, device="cuda", max_length=77, ckpt_path=None):
        super().__init__()
        self.device = device
        self.max_length = max_length
        
        self.ch_clip_model = AltCLIPModel.from_pretrained(ckpt_path)
