...
class Japanese_Stable_Diffusion_Inference_API():
    ...
    def __init__(self, config) -> None:
        ...
        self.pipe = JapaneseStableDiffusionPipeline.from_pretrained(self.config.model_base, scheduler=scheduler).to("cuda")
...
if __name__ == '__main__':
    ...
    for datum in tqdm(data_total, desc="Generating:"):
        ...
        datum['japanese_sd_generated_image'] = args.save_dir + '/' + file_name
